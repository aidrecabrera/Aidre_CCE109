    ...
    public class SIMPLE_SYSTEM {
        public static void main(String[] args) {
            SYSTEM_VERSIONS system_versions = new SYSTEM_VERSIONS();
            system_versions.INITIAL_RELEASE();
            system_versions.SECOND_RELEASE();
         }
    }

    class SYSTEM_VERSIONS {
        void INITIAL_RELEASE() {
            ...
            System.out.println("Highest Grade: " + COURSE_DATABASE[COURSE_DATABASE.length-1]);
        ...
        void SECOND_RELEASE() {
            ...
            System.out.println("Subject Grades: " + COURSE_DATABASE.toString());
